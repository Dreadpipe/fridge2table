...
function FullFridge(props) {
  return (
    <ImageBackground style={styles.backgroundImage} source={{uri: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTCuAEew-ZQhUVrZkEKdmWvrSqbzdNenK_pI1RKoxMd6_B5vLAJ"}}>
